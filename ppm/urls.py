...
urlpatterns = [
    ...
    path('reservations_precedentes/', views.reservations_precedentes, name='reservations_precedentes'),
    path('gestion_stats_rapports/', views.gestion_stats_rapports, name='gestion_stats_rapports'),
    path('gestion_equipements/', views.gestion_equipements, name='gestion_equipements'),
